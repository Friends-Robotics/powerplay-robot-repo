...
@TeleOp(name="Two Motor Test", group="Linear Opmode")
public class TwoMotorTestMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            gamepadInputs[1] = gamepad1.right_stick_y;
            ...
            telemetry.addData("Input", "Motor 1: (%.2f); Motor 2: (%.2f)", gamepadInputs[0], gamepadInputs[1]);
            telemetry.update();
        }
    }
